        ...
        <v-window v-model="tab">
          ...
          >
            <v-table>
              ...
              <tbody>
                <tr v-for="weapon in category.items" :key="weapon.name">
                  <td>{{ weapon.name }}</td>
                  <td class="text-center">{{ weapon.damage }}</td>
                  <td class="text-center">{{ weapon.properties }}</td>
                  <td class="text-center">{{ weapon.mastery }}</td>
                  <td class="text-center">{{ weapon.weight }}</td>
